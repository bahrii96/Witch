...
function detect_assets()
{
	...
	if (!is_admin()) {
		...
		if (is_page_template('views/page-services.php')) {
			wp_enqueue_style('page-services', get_stylesheet_directory_uri()
				. '/assets/css/pages/page-services.css', array(), null);
		}
		/* Connect main style */
		...
		wp_enqueue_style('mak', get_stylesheet_directory_uri()
			. '/assets/fonts/mak/styles.css', array(), null);

		wp_enqueue_style('display', get_stylesheet_directory_uri()
			. '/assets/fonts/display/styles.css', array(), null);
